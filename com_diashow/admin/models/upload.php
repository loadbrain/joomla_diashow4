 ...
 * Upload Model
 */
class DiashowModelUpload extends JModelAdmin
{
    /**
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_diashow.upload', 'upload', array('control' => 'jform', 'load_data' => $loadData));
        if (empty($form)) {
            return false;
        }
        return $form;
    ...
    {
        return JFolder::files(DiashowsHelper::makeSafe(JPATH_ROOT . "/images/diashow"), $filter= '.', $recurse=true);
    }
