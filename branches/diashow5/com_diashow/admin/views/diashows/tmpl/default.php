...
<form action="<?php echo JRoute::_('index.php?option=com_diashow&view=diashows'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif; ?>
		<div id="filter-bar" class="btn-toolbar">
			<div class="filter-search btn-group pull-left">
				...
				<input type="text" name="filter_search" id="filter_search" placeholder="<?php echo JText::_('COM_DIASHOW_SEARCH_IN_TITLE'); ?>" value="<?php echo $this -> escape($this -> state -> get('filter.search')); ?>" title="<?php echo JText::_('COM_DIASHOW_SEARCH_IN_TITLE'); ?>" />
			</div>
...
?>	
                ...
                <?php if ($canEdit){?>
                        <a href="<?php echo JRoute::_('index.php?option=com_diashow&task=diashow.edit&id=' . $item -> id); ?>"><?php echo JTEXT::_($item->title); ?></a>
                 <?php } else{
